...
using IResult = Infrastructure.Common.Result.IResult;
using ResultStatus = Infrastructure.Common.Result.ResultStatus;
...
public static class ResultExtensions
{
    ...
    static internal ActionResult ToActionResult(this ControllerBase controller, IResult result)
    {
    ...
    private static ActionResult UnprocessableEntity(ControllerBase controller, IResult result)
    {
        ...
        return BadRequest(controller, result);
