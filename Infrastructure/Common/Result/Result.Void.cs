...
public class Result : Result<Result>
{
    ...
    public Result(Result result) : base(result.Data, result.SuccessMessage) // TODO maybe unneeded 
    {
    ...
    [JsonIgnore] public Result Data { get; }
    ...
    /// </summary>
    /// <param name="data">Sets the Value property</param>
